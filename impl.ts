...
export function* map<T, U>(iter: IterableIterator<T>, fn: SelectorFunction<T, U>): IterableIterator<U> {
    let i = 0;
...
export function* flatten<T, U>(iter: IterableIterator<T>, fn: SelectorFunction<T, Iterable<U>>): IterableIterator<U> {
    let i = 0;
...
export function* filter<T>(iter: IterableIterator<T>, fn: PredicateFunction<T>): IterableIterator<T> {
    let i = 0;
...
export function* takeWhile<T>(iter: IterableIterator<T>, predicate: PredicateFunction<T>): IterableIterator<T> {
    let i = 0;
